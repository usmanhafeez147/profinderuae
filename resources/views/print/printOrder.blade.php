                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                <b>Customer Name:</b> {{$order->company->contact_name}}<br>
                                <b>Order #:</b> {{ $order->id}} <br>
                                <b>Created:</b> {{ $order->order_date}} <br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        <tr>
                            <td>
                                <b>Address:</b> {{ $order->company->address}}  
                            </td>
                            
                            <td>
                                <b>Company Name:</b> {{ $order->company->name}} <br>
                                <b>Email Address:</b> {{ $order->company->email}}
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <br>
                                    Name of the company: {{ $order->company->name}}<br> 
                                    Tax ID no:<br>
                                    Phone number: {{ $order->company->phone}}<br>
                                    Address: {{ $order->company->address}}<br>
                                    Zip Code: {{ $order->company->zipcode}}<br>
                                    City: {{ $order->company->city->name}}<br>
                                    Business/Opening hours:<br>
                                    Email: {{ $order->company->email}}<br>
                                    www: {{ $order->company->weblink}}<br>
                                    Industry:<br>
                                    Info Text:<br>
                                    Keywords: <br>
